...
//              *oni_dataFile.newData[1]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+1]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][1]);
//              *oni_dataFile.newData[2]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+2]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][2]);
//              *oni_dataFile.newData[3]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+3]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][3]);
//              *oni_dataFile.newData[4]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+4]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][4]);
//              *oni_dataFile.newData[5]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+5]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][5]);
//              *oni_dataFile.newData[6]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+6]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][6]);
//              *oni_dataFile.newData[7]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+7]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][7]);
//              *oni_dataFile.newData[8]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+8]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][8]);
...
//              *oni_dataFile.newData[10]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+10]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][10]);
//              *oni_dataFile.newData[11]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+11]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][11]);
//              *oni_dataFile.newData[12]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+12]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][12]);
//              *oni_dataFile.newData[13]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+13]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][13]);
//              *oni_dataFile.newData[14]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+14]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][14]);
//              *oni_dataFile.newData[15]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+15]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][15]);
//              *oni_dataFile.newData[16]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+16]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][0]);
//              *oni_dataFile.newData[17]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+17]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][1]);
...
//              *oni_dataFile.newData[19]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+19]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][3]);
//              *oni_dataFile.newData[20]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+20]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][4]);
//              *oni_dataFile.newData[21]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+21]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][5]);
//              *oni_dataFile.newData[22]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+22]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][6]);
//              *oni_dataFile.newData[23]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+23]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][7]);
//              *oni_dataFile.newData[24]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+24]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][8]);
//              *oni_dataFile.newData[25]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+25]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][9]);
//              *oni_dataFile.newData[26]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+26]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][10]);
...
//              *oni_dataFile.newData[28]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+28]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][12]);
//              *oni_dataFile.newData[29]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+29]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][13]);
//              *oni_dataFile.newData[30]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+30]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][14]);
//              *oni_dataFile.newData[31]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+31]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][15]);
//              *oni_dataFile.newData[32]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+32]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][0]);
//              *oni_dataFile.newData[33]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+33]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][1]);
//              *oni_dataFile.newData[34]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+34]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][2]);
//              *oni_dataFile.newData[35]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+35]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][3]);
...
//              *oni_dataFile.newData[37]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+37]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][5]);
//              *oni_dataFile.newData[38]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+38]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][6]);
//              *oni_dataFile.newData[39]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+39]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][7]);
//              *oni_dataFile.newData[40]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+40]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][8]);
//              *oni_dataFile.newData[41]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+41]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][9]);
//              *oni_dataFile.newData[42]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+42]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][10]);
//              *oni_dataFile.newData[43]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+43]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][11]);
//              *oni_dataFile.newData[44]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+44]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][12]);
...
//              *oni_dataFile.newData[46]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+46]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][14]);
//              *oni_dataFile.newData[47]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+47]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][15]);
//              *oni_dataFile.newData[48]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+48]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][0]);
//              *oni_dataFile.newData[49]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+49]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][1]);
//              *oni_dataFile.newData[50]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+50]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][2]);
//              *oni_dataFile.newData[51]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+51]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][3]);
//              *oni_dataFile.newData[52]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+52]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][4]);
//              *oni_dataFile.newData[53]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+53]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][5]);
...
//              *oni_dataFile.newData[55]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+55]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][7]);
//              *oni_dataFile.newData[56]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+56]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][8]);
//              *oni_dataFile.newData[57]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+57]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][9]);
//              *oni_dataFile.newData[58]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+58]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][10]);
//              *oni_dataFile.newData[59]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+59]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][11]);
//              *oni_dataFile.newData[60]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+60]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][12]);
//              *oni_dataFile.newData[61]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+61]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][13]);
//              *oni_dataFile.newData[62]<<QPointF(oni_realData.curEndX,filterTemp[startFilterPos+62]+INTERFACE_RANGE_BASE_VALUE[oni_rangeBase][14]);
